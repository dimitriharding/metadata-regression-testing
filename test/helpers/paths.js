...
exports.updatedDiffFilePath = `${updatedBase}/diffs/github.com_VS_www.google.com_homepage.json.txt`;
exports.diffFilePath = `${base}/diffs/_homepage.json.txt`;
exports.diffFilePathForDifferentDomains = `${base}/diffs/www.google.com_VS_github.com_homepage.json.txt`;
exports.diffboardPath = `${base}/diffboard`;
